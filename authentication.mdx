...
Codifique sua chave Pública e Secreta em [Base64](https://www.base64encode.org/):
`pk_live_xxxxxxxx : sk_live_yyyyyyyy`

**1.** Concatene as duas chaves com `:` (dois pontos) entre elas.
**2.** Aplique base64 no resultado.
...
axios.post('https://api.legacy.com.br/payin', payload, {
  headers: {
