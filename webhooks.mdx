...
- `MED` - Seu cliente contestou com o banco emissor o uso indevido da compra.
...
_Geralmente, um Payout trafegará pelo status `PROCESSING` até consolidar-se em_ `APPROVED `_ou `FAILED`._
