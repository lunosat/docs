...
<ParamField body="card" type="object">
  <Expandable title="propriedades de criptografia">
    <ParamField body="holderName" type="string" required>
      Nome impresso no plástico do cartão.
    </ParamField>
     <ParamField body="number" type="string" required>
      Os dezesseis dígitos ou Token Sensível.
    </ParamField>
     ...
     <ParamField body="cvv" type="string" required>
      Três ou quatro dígitos de trás.
    </ParamField>
     <ParamField body="installments" type="integer" required>
      Quantidade de parcelas solicitadas na maquininha sem juros (Ex: 1 a 12).
    </ParamField>
